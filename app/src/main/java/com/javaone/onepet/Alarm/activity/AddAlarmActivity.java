...
public class AddAlarmActivity extends AppCompatActivity {
    ...
    private RapidFloatingActionButton mFAB1;
    private RapidFloatingActionButton mFAB2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFAB1 = (RapidFloatingActionButton) findViewById(R.id.starred1);
        mFAB2 = (RapidFloatingActionButton) findViewById(R.id.starred2);
    ...
    public void selectTime(View v){
        ...
        TimePickerDialog timeDialog = new TimePickerDialog(AddAlarmActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    /*@Override
    public void onTimeSet(RapidFloatingActionLayout view, int hourOfDay, int minute) {
        mHour = hourOfDay;
        mMinute = minute;
        if (minute < 10) {
            mTime = hourOfDay + ":" + "0" + minute;
    ...
    private void saveAlarm() {
        ...
        intent2.setClass(AddAlarmActivity.this, AlarmMainActivity.class);
