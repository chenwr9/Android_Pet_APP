...
public class EditAlarmActivity extends AppCompatActivity {
    ...
    public void selectTime(View v){
        ...
        TimePickerDialog timeDialog = new TimePickerDialog(EditAlarmActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
...
/*    @Override
    ...
    private void showRingDialog(DialogInterface lastDialog) {
        ...
        builder.setSingleChoiceItems(ringList, 0, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                //  Toast.makeText(EditAlarmActivity.this, "Debug1", Toast.LENGTH_LONG).show();
