package com.javaone.onepet.Alarm.activity;
...
import com.javaone.onepet.Alarm.Utils.ActivityManager;
import com.javaone.onepet.Alarm.Utils.DividerItemDecoration;
import com.javaone.onepet.Alarm.Utils.MyTimeSorter;
...
public class AlarmMainActivity extends AppCompatActivity implements RapidFloatingActionContentLabelList.OnRapidFloatingActionContentLabelListListener{

    private MyAlarmDataBase db;
    private Toolbar mToolBar;
    private RapidFloatingActionButton mAddAlarmBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddAlarmBtn = (RapidFloatingActionButton) findViewById(R.id.add_reminder);
    ...
    private void initFab() {
        ...
        items.add(new RFACLabelItem<Integer>()
                .setLabel("添加闹钟")
                .setResId(R.drawable.rfab__drawable_rfab_default)
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.mOverFlowImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    cancelAlarm(AlarmMainActivity.this, id, alarm);

                    Toast.makeText(AlarmMainActivity.this, "已删除闹钟", Toast.LENGTH_SHORT).show();
...
//            PopupMenu menu = new PopupMenu(AlarmMainActivity.this, v);
                ...
                mActiveImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (item.mActive.equals("true")) {
                            ...
                            cancelAlarm(AlarmMainActivity.this, CheckedAlarmID, alarmModel);
                            Toast.makeText(AlarmMainActivity.this, "已关闭闹钟", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(AlarmMainActivity.this, "已开启闹钟", Toast.LENGTH_SHORT).show();
